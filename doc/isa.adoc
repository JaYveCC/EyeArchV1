...
| CAL | 100100 | B | cs.push(pc); pc = imm | false
| RET | 100101 | B | pc = cs.pop | false
| BIN | 100110 | B | interrupt_pin_enable = false | false
| EIN | 100111 | B | interrupt_pin_enable = true | false
